...
namespace AdventOfCodeDec4Tests
{
    public class AdventOfCodeDec4Tests
    {
        ...
        public void ScratchcardReader_SingleLineExampleTest()
        {
            ...
            ScratchcardReader scratchcardReader = new ScratchcardReader(input);

            int expectedResult = 8;

            // Process

            int result = scratchcardReader.ReadCard();
        ...
        public void ScratchcardCollection_ExampleTest()
        {
            ...
            ScratchcardCollection scratchcardCollection = new ScratchcardCollection(input);
